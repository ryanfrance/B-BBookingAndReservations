...
import (
	...
	"github.com/ryanfrance/B-BBookingAndReservations/internal/forms"
	...
	"github.com/ryanfrance/B-BBookingAndReservations/internal/repository/dbrepo"
)
...
func (m *Repository) PostAvailability(w http.ResponseWriter, r *http.Request) {
	...
	if len(rooms) == 0 {
		// No availability
		m.App.Session.Put(r.Context(), "error", "No availability for your chosen dates")
...
func (m *Repository) ChooseRoom(w http.ResponseWriter, r *http.Request) {
	...
	res, ok := m.App.Session.Get(r.Context(), "reservation").(models.Reservation)
	if !ok {
		helpers.ServerError(w, errors.New("type assertion to Reservation model has failed"))
		return
	}
